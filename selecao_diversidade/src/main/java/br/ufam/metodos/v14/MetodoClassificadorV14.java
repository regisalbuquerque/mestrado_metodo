 ...
 */
public class MetodoClassificadorV14 extends AbstractClassifier implements DetectorDrift, IEnsembleSelection {
...
//			',');
	...
	private void randomizaLambdasEnsembles()
	{
		this.gerarLambdas();
		for (int i = 0; i < this.poolOfEnsembles.length; i++) {
