 ...
 *    
 */
package br.ufam.metodos.leveraging.v1;
 ...
 * @version $Revision: 7 $
 */
public class LeveragingBagOriginal extends AbstractClassifier implements DetectorDrift{
    ...
    protected boolean driftVAR = false;
