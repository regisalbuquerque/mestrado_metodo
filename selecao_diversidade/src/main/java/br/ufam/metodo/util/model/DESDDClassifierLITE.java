...
public abstract class DESDDClassifierLITE extends AbstractClassifier implements DetectorDrift, IEnsembleSelection, IEnsemblesResultados {
	...
	public void trainOnInstanceImpl(Instance inst) {
		...
		if (selectionOptionEstrategiaRecuperacao.getChosenLabel().equals("RetreinaTodosComBufferWarning") 
				|| selectionOptionEstrategiaRecuperacao.getChosenLabel().equals("SimpleResetSystem1Detector")) {
